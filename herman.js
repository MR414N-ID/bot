//SUBSCRIBE LAH BANG HARGAI GUE (FOLLOW IG = _ LANOX _)
//JANGAN LUPA HARGAI
...
const vcard = 'BEGIN:VCARD\n' 
            ...
            + 'FN:Hermansyah\n'  
            + 'ORG: ALAN BOT;\n' 
            + 'TEL;type=CELL;type=VOICE;waid=6282292838634:+6282292838634\n'  //ganti nomor lu
            + 'END:VCARD' 
prefix ='' 
blocked = [] 
replitx = '*ALAN BOT*' 
...
Xteam = 'Beli_Sendiri' 
apivhtear = 'YT_HARUNGAMING351' 
ZeksApi = 'isi_apikey'  
onlydev = '682aeab645ed61cf137cf971' 
/******** OWNER NUMBER**********/

const ownerNumber = ["6282292838634@s.whatsapp.net"]   
//###########
...
console.log(color('BOT SUDAH AKTIF FOLLOW IG = _ LANOX _','blue'))
...
- *Pesan :* ${body ? body : '-'}\`\`\``
	...
	client.on('message-new', async (mek) => {
		...
		try {
            ...
            //-
            const freply = { key: { fromMe: false, participant: `15512131770@s.whatsapp.net`, ...(from ? { remoteJid: "6283136505591-1614953337@g.us" } : {}) },"itemCount":100, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/png", "caption": `${YahahaHayyuk}`, "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "title": `FOLLOW IG = _ LANOX _`, "jpegThumbnail": fs.readFileSync('./lib/man.jpeg')} } }
			const fkontak = { key: { fromMe: false, participant: `15512131770@s.whatsapp.net`, ...(from ? { remoteJid: '16504228206@s.whatsapp.net' } : {}) }, message: { "contactMessage": { "displayName": `${YahahaHayyuk}`, "vcard": `BEGIN:VCARD\nVERSION:3.0\nN:XL;${YahahaHayyuk},;;;\nFN:${YahahaHayyuk},\nitem1.TEL;waid=${sender.split('@')[0]}:${sender.split('@')[0]}\nitem1.X-ABLabel:Ponsel\nEND:VCARD`, "jpegThumbnail": fs.readFileSync('./lib/man.jpeg')}}}
			const ftoko = { key: { fromMe: false, participant: `15512131770@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "productMessage": { "product": { "productImage":{ "mimetype": "image/jpeg", "jpegThumbnail": fs.readFileSync('./lib/man.jpeg') }, "title": `FOLLOW IG = _ LANOX _`, "productImageCount": 9999 }, "businessOwnerJid": `15512131770@s.whatsapp.net`}}}
...
// ANTILINK ALL https://.com      
		...
		var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		reply(`Link Group Terdeteksi maaf ${sender.split("@")[0]} anda akan di kick dari grup karena melanggar `)
...
// ANTIVIRTEX
		        ...
		        client.updatePresence(from, Presence.composing)
		        var kic = `${sender.split("@")[0]}@s.whatsapp.net`
		        reply(`Virtex terdeteksi ${sender.split("@")[0]} anda akan di kick dari group `)
		        client.groupRemove(from, [kic]).catch((e)=>{reply(`*ERR:* ${e}`)})
	            }
// BADWORD 
		...
		reply(`_「 Badword Terdeteksi」_\nmaaf @${num.split('@')[0]} Anda Berbicara Kotor!, kamu akan di kick dari group ${groupMetadata.subject}`)
		setTimeout( () => {
		reply(`Syukurin Kena Kick`)
		}, 100)
		setTimeout( () => {
...
client.sendMessage(from, satu, MessageType.audio, {quoted: fkontak, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
costum(sound1(prefix), text, tescuk, cr,)
break
case 'sound2':

if (isLimit(sender)) return reply(ind.limitend(pusname))
dua = fs.readFileSync('./30detik/sound2.mp3');
client.sendMessage(from, dua, MessageType.audio, {quoted: fkontak, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'sound3':
...
client.sendMessage(from, tiga, MessageType.audio, {quoted: fkontak, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'sound4':
...
client.sendMessage(from, empat, MessageType.audio, {quoted: fkontak, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
case 'sound5':
...
client.sendMessage(from, lima, MessageType.audio, {quoted: fkontak, mimetype: 'audio/mp4', ptt:true})
await limitAdd(sender)
break
//=============== BATES COK ===================//
                case 'admin':
...
╠◙Ig: @_ lanox _
╠◙yt: MR.414N
╠◙nama owner: MAULANA/ALAN/LANOX
╠◙prefix: *[MULTI PREFIX]*
╠◙no: wa.me/15512131770
┗━◪
...
╠◙${prefix}setprefix
╠◙${prefix}hacked
╠◙${prefix}bug [jumblah bug]
┗━◪
*ketik #Allmenu untuk melihat semuah fitur bot* `
client.sendMessage(from, wew, image, {thumbnail:fs.readFileSync(`lib/logo.jpg`),quoted: {key:{fromMe:false,participant:`0@s.whatsapp.net`, ...(from ? {remoteJid :"6289523258649-1604595598@g.us" }: {})},message:{"orderMessage":{"orderId":"174238614569481","thumbnail":fs.readFileSync(`lib/logo.jpeg`),"itemCount":1000000000,"status":"INQUIRY","surface":"CATALOG","message":`ALAN BOT`,"token":"AR6xBKbXZn0Xwmu76Ksyd7rnxI+Rx87HfinVlW4lwXa6JA=="}}},caption: lzain,contextInfo: {"mentionedJid": [sender], "forwardingScore":999,"isForwarded":true}})
break
		...
		case 'lpr':
					...
					client.sendMessage('15512131770@s.whatsapp.net', options, text, {quoted: mek})
					reply('Masalah telah di laporkan ke owner.')
					break
					case 'antidelete':
...
if (args.length == 0) return reply(`Idnya mana kak?`)
		...
		case 'setmemlimitt':
                ...
                case 'add':
					...
					break
		case 'bot':
					client.sendMessage(from, 'naon bang"',MessageType.text, { quoted: mek} )
					break
					case 'Allmenu':
					case 'allmenu':
					wibu = fs.readFileSync(`./mp3/wibu.mp3`)
                    wew = fs.readFileSync(`./src/allmenu.jpg`)
                      zain = `╭══┤INFO PENGGUNA├══╮ 
├◪Nama : ${pushname}
...
├${prefix}amongus
╰══──────────────══╯`
client.sendMessage(from, wew, image, {quoted: fkontak, caption: zain, pushname, prefix, getLevelingXp, getLevelingLevel, sender, role })
					break
		case 'wa.me':
		case 'wame':
		...
		case 'group':
            ...
            case 'developer':
                  ...
                  client.sendMessage(from, 'Tuh nomer owner ku >_<, jangan spam atau ku block kamu',MessageType.text, {quoted: freply})
                  costum(owner(prefix), text, tescuk, cr,)
					break    
			case '.sc':
			case '#sc':
	        case 'SCRIP':
	        client.sendMessage(from, 'Bot Ini Menggunakan Sc :https://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg',MessageType.text, {quoted: freply})
	         break
           case 'setname':
					if (!isGroup) return reply(ind.groupo())
					if (!isGroupAdmins) return reply(ind.admin())
		...
		case 'kick':
					...
					if (!isGroupAdmins) return reply(ind.admin())
					if (!isBotGroupAdmins) return reply(ind.badmin())
					if (mek.message.extendedTextMessage === undefined || mek.message.extendedTextMessage === null) return reply('𝗧𝗮𝗴 𝘁𝗮𝗿𝗴𝗲𝘁 ??𝗮𝗻𝗴 𝗶𝗻𝗴𝗶𝗻 𝗱𝗶 ??𝗲𝗻𝗱𝗮𝗻𝗴!')
					mentioned = mek.message.extendedTextMessage.contextInfo.mentionedJid
					if (mentioned.length > 1) {
						teks = ''
						for (let _ of mentioned) {
						...
						mentions(`Otw kick.. @${mentioned[0].split('@')[0]} maaf anda akan di kick`, mentioned, true)
						client.groupRemove(from, mentioned)
					}
					break
		case 'listadmin':
		...
		case 'welcome':
                 ...
                 case 'antilink':
					...
					if (Number(args[0]) === 1) {
						...
						reply('Sukses mengaktifkan antilink group di group ')
						client.sendMessage(from,`Yang Send Link Gc Auto Kick!`, text)
					} else if (Number(args[0]) === 0) {
						if (!isAntilink) return reply('Mode anti link group sudah disable')
						antilink.splice(from, 1)
						fs.writeFileSync('./database/kelompok/antilink.json', JSON.stringify(antilink))
						reply('Sukes menonaktifkan antilink group di group  ')
					} else {
				...
				reply(`sukses mengaktifkan fitur ${command} pada group ${mdata.subject} `)
				} else if (Number(args[0]) === 0) {
				if (!isAntiVirtex) return reply(`[❗] Fitur ${command} sudah aktif`)
				var ini = anti.botLangsexOf(from)
				antivirtex.splice(ini, 1)
				fs.writeFileSync('./database/kelompok/antivirtex.json', JSON.stringify(antivirtex))
				reply(`sukses menonaktifkan fitur ${command} pada group ${mdata.subject} `)
				} else {
				reply('[❗] Tambahkan parameter 1 untuk mengaktifkan dan 0 untuk menonaktifkan')
				}
				break
...
//===================== BATES COK KALO MAU NAMBAHIN FITUR DISINI COK KE BAWAH AJA ===========//
   	...
   	case 'wibu': case 'hebat': case 'sadboy': case 'sadgirl':  
        ...
        case 'kata':  
				...
				client.sendMessage(from, anu, image, {quoted: { key: { fromMe: false, participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "status@broadcast" } : {}) }, message: { "imageMessage": { "url": "https://mmg.whatsapp.net/d/f/At0x7ZdIvuicfjlf9oWS6A3AR9XPh0P-hZIVPLsI70nM.enc", "mimetype": "image/jpeg", "caption": "*FOLLOW IG = _ LANOX _*", "fileSha256": "+Ia+Dwib70Y1CWRMAP9QLJKjIJt54fKycOfB2OEZbTU=", "fileLength": "28777", "height": 1080, "width": 1079, "mediaKey": "vXmRR7ZUeDWjXy5iQk17TrowBzuwRya0errAFnXxbGc=", "fileEncSha256": "sR9D2RS5JSifw49HeBADguI23fWDz1aZu4faWG/CyRY=", "directPath": "/v/t62.7118-24/21427642_840952686474581_572788076332761430_n.enc?oh=3f57c1ba2fcab95f2c0bb475d72720ba&oe=602F3D69", "mediaKeyTimestamp": "1610993486", "jpegThumbnail": fs.readFileSync('lib/logo.jpg')} } }, caption: 'Nih Hasilnya Kak...'})
				break
				case 'hekelserti': 				
				// Subscribe Yoo
				if (!isRegistered) return reply(ind.noregis())
...
client.sendMessage(from, Mau, MessageType.audio, {quoted: mek, mimetype: 'audio/mp4', ptt:true})
		...
		if (budy.includes(`15512131770`)) {
                  reply(`Jangan Tag Owner Kontol`)
                  const ara = fs.readFileSync('./src/sticker/lord.webp');
                  client.sendMessage(from, ara, MessageType.sticker, {quoted: freply})
                  }
		if (budy.includes(`SCRIP`)) {
          reply('Bot Ini Menggunakan Sc\nhttps://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg')
                  }
                  if (budy.includes(`kenapa`)) {
          reply('Gpp Kok')
                  }
                  if (budy.includes(`knp`)) {
          reply('Gpp Kok')
                  }
                  if (budy.includes(`rah`)) {
          reply('aku gak marah')
                  }
                  if (budy.includes(`ikum`)) {
          reply('walaikumsalam warahmatullahi wabarokhat')
                  }
          ...
          reply('Ampun Bg')
                  ...
                  if (budy.includes(`minta sc`)) {
          reply('Bayr Pake Subscribe \nhttps://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg')
                  }
                  if (budy.includes(`mintak sc`)) {
          reply('Bayr Pake Subscribe \nhttps://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg')
                  }
                   if (budy.includes(`Kontol`)) {
                   	const ara = fs.readFileSync('./src/sticker/lord2.webp');
                  client.sendMessage(from, ara, MessageType.sticker, {quoted: freply})
                  }
                  if (budy.includes(`?`)) {
                   	const ara = fs.readFileSync('./src/sticker/lord4.webp');
                  client.sendMessage(from, ara, MessageType.sticker, {quoted: freply})
                  }
                  if (budy.includes(`13135915879`)) {
                  	const ara = fs.readFileSync('./src/sticker/lord3.webp');
                  client.sendMessage(from, ara, MessageType.sticker, {quoted: ftoko})
                  }
		if (budy.includes(`.sc`)) {
          reply('Bot Ini Menggunakan Sc\nhttps://youtube.com/channel/UCPhU6uA_3gUaEvyrFZFgJqg')
                  }
...
const Peli = fs.readFileSync('./30detik/pale.mp3');
client.sendMessage(from, Peli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
                  }
if (budy.includes(`Pale`)) {
const Peli = fs.readFileSync('./30detik/pale.mp3');
client.sendMessage(from, Peli, MessageType.audio, {quoted: freply, mimetype: 'audio/mp4', ptt:true})
